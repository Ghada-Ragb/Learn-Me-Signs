...
import 'package:learn_me_signs/widgets/AnswerOptionArabicDays.dart';

class QuestionCardArabicDays extends StatelessWidget {
  final QuestionArabicModel questionModel;

  const QuestionCardArabicDays({
    Key? key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...List.generate(
                      ...
                      (index) => Column(
                            children: [
                              AnswerOptionsArabicDays(
                                  questionId: questionModel.id,
                                  text: questionModel.options[index],
                                  index: index,
                                  onPressed: () => Get.find<QuizArabicDays>()
