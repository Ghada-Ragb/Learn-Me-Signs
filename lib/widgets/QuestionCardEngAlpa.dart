...
import 'package:learn_me_signs/widgets/AnswerOptionsEngAlpa.dart';

class QuestionCardEngAlpa extends StatelessWidget {
  final QuestionArabicModel questionModel;

  const QuestionCardEngAlpa({
    Key? key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...List.generate(
                      ...
                      (index) => Column(
                            children: [
                              AnswerOptionsEngAlpa(
                                  questionId: questionModel.id,
                                  text: questionModel.options[index],
                                  index: index,
                                  onPressed: () => Get.find<QuizEngAlap>()
