...
class QuizEngDay extends GetxController {
  String name = '';
  //question variables
  ...
  final List<QuestionArabicModel> _questionsList = [
    QuestionArabicModel(
        id: 1,
        question: "assets/images/DayEng/Fri.jpg",
        answer: 0,
        options: ["Friday", "Saturday", "Wednesday"]),
    QuestionArabicModel(
        id: 2,
        question: "assets/images/DayEng/Mon.jpg",
        answer: 2,
        options: ['Thesday', 'Thursday', 'Monday']),
    QuestionArabicModel(
        id: 3,
        question: "assets/images/DayEng/Sat.jpg",
        answer: 1,
        options: ["Sunday", "Saturday", "Friday"]),
    QuestionArabicModel(
        id: 4,
        question: "assets/images/DayEng/Sun.jpg",
        answer: 0,
        options: ["Sunday", "Saturday", "Thursday"]),
    QuestionArabicModel(
        id: 5,
        answer: 0,
        question: "assets/images/DayEng/Th.jpg",
        options: ["Thursday", "Friday", "Wednesday"]),
    QuestionArabicModel(
        id: 6,
        question: "assets/images/DayEng/Tu.jpg",
        answer: 1,
        options: ["Friday", "Tuesday", "Monday"]),
    QuestionArabicModel(
        id: 7,
        question: "assets/images/DayEng/We.jpg",
        answer: 2,
        options: ["Monday", "Thuesday", "Wednesday"]),
  ];
  ...
  void nextQuestion() {
    ...
    if (pageController.page == _questionsList.length - 1) {
      Get.offAndToNamed(ResultScreenEngDay.routeName);
    } else {
      _isPressed = false;
  ...
  void startAgain() {
    ...
    resetAnswer();
    _selectAnswer = null;
    Get.offAllNamed(WelcomeScreenEngDay.routeName);
  }
}
