...
class QuizEngNum extends GetxController {
  String name = '';
  //question variables
  ...
  final List<QuestionArabicModel> _questionsList = [
    QuestionArabicModel(
        id: 1,
        question: "assets/images/NumbersEng/eight.jpg",
        answer: 2,
        options: ["10", "6", "8"]),
    QuestionArabicModel(
        id: 2,
        question: "assets/images/NumbersEng/five.jpg",
        answer: 2,
        options: ['2', '9', '5']),
    QuestionArabicModel(
        id: 3,
        question: "assets/images/NumbersEng/four.jpg",
        answer: 1,
        options: ["1", "4", "6"]),
    QuestionArabicModel(
        id: 4,
        question: "assets/images/NumbersEng/nine.jpg",
        answer: 0,
        options: ["9", "10", "4"]),
    QuestionArabicModel(
        id: 5,
        answer: 1,
        question: "assets/images/NumbersEng/one.jpg",
        options: ["2", "1", "10"]),
    QuestionArabicModel(
        id: 6,
        question: "assets/images/NumbersEng/seven.jpg",
        answer: 2,
        options: ["5", "6", "7"]),
    QuestionArabicModel(
        id: 7,
        question: "assets/images/NumbersEng/six.jpg",
        answer: 1,
        options: ["8", "6", "9"]),
    QuestionArabicModel(
        id: 8,
        question: "assets/images/NumbersEng/ten.jpg",
        answer: 2,
        options: ["7", "1", "10"]),
    QuestionArabicModel(
        id: 9,
        question: "assets/images/NumbersEng/three.jpg",
        answer: 0,
        options: ["3", "6", "8"]),
    QuestionArabicModel(
        id: 10,
        question: "assets/images/NumbersEng/two.jpg",
        answer: 2,
        options: ["7", "1", "2"]),
  ];
  ...
  void nextQuestion() {
    ...
    if (pageController.page == _questionsList.length - 1) {
      Get.offAndToNamed(ResultScreenEngNum.routeName);
    } else {
      _isPressed = false;
  ...
  void startAgain() {
    ...
    resetAnswer();
    _selectAnswer = null;
    Get.offAllNamed(WelcomeScreenEngNum.routeName);
  }
}
