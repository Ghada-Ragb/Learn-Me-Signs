...
class WelcomeScreenEngNum extends StatefulWidget {
  const WelcomeScreenEngNum({Key? key}) : super(key: key);
  static const routeName = '/welcome_screen6';

  @override
  State<WelcomeScreenEngNum> createState() => _WelcomeScreenEngNumState();
}

class _WelcomeScreenEngNumState extends State<WelcomeScreenEngNum> {
  ...
  void _submit(context) {
    ...
    Get.offAndToNamed(QuizScreenEngNum.routeName);
    Get.find<QuizEngNum>().startTimer();
  }
