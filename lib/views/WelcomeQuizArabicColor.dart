...
class WelcomeScreenArabicColor extends StatefulWidget {
  const WelcomeScreenArabicColor({Key? key}) : super(key: key);
  static const routeName = '/welcome_screen3';

  @override
  State<WelcomeScreenArabicColor> createState() =>
      _WelcomeScreenArabicColorState();
}

class _WelcomeScreenArabicColorState extends State<WelcomeScreenArabicColor> {
  ...
  void _submit(context) {
    ...
    Get.offAndToNamed(QuizScreenArabicColor.routeName);
    Get.find<QuizArabicColor>().startTimer();
  }
