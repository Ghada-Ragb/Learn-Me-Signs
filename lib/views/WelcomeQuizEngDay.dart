...
class WelcomeScreenEngDay extends StatefulWidget {
  const WelcomeScreenEngDay({Key? key}) : super(key: key);
  static const routeName = '/welcome_screen8';

  @override
  State<WelcomeScreenEngDay> createState() => _WelcomeScreenEngDayState();
}

class _WelcomeScreenEngDayState extends State<WelcomeScreenEngDay> {
  ...
  void _submit(context) {
    ...
    Get.offAndToNamed(QuizScreenEngDay.routeName);
    Get.find<QuizEngDay>().startTimer();
  }
