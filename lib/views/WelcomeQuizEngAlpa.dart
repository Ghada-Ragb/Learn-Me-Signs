...
class WelcomeScreenEngAlpa extends StatefulWidget {
  const WelcomeScreenEngAlpa({Key? key}) : super(key: key);
  static const routeName = '/welcome_screen5';

  @override
  State<WelcomeScreenEngAlpa> createState() => _WelcomeScreenEngAlpaState();
}

class _WelcomeScreenEngAlpaState extends State<WelcomeScreenEngAlpa> {
  ...
  void _submit(context) {
    ...
    Get.offAndToNamed(QuizScreenEngAlpa.routeName);
    Get.find<QuizEngAlap>().startTimer();
  }
